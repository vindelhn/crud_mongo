...
import {getAllSintomasYPaciente,deleteSintomaPaciente} from "./client";
import {
  Layout,
  Menu,
  Breadcrumb,
...
import SintomaPacienteDrawerForm from "./SintomaPacienteDrawerForm";
...
const removeSintoma = (sintomaId, callback) => {
  deleteSintomaPaciente(sintomaId).then(() => {
...
const columns = fetchSintomas => [
  ...
  {
    title: 'Apellido',
    dataIndex: 'apellidoPaciente',
    key: 'apellidoPaciente',
  },
  {
    title: 'Sintoma',
    dataIndex: 'nombreSintoma',
    key: 'nombreSintoma',
  },
  {
    title: 'Actions',
...
export default SintomasPacientes;
